...
const DATA = {
  ...
  contact: {
    social: {
      Instagram: {
        name: "instagram",
        url: "https://www.instagram.com/comet.app/",
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "www.linkedin.com/in/comet-934400321",
        icon: Icons.linkedin,
      },
      // email: {
      //   name: "Send Email",
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-6xl font-bold text-yellow-400 mb-8 font-playwrite">
          comet.
        </h1>
        <h1 className="text-6xl md:text-8xl font-bold text-gray-200 mb-4">
          Campus Life.
        </h1>
        <h1 className="text-6xl md:text-8xl font-bold text-yellow-400 mb-8 font-playwrite">
          Reimagined.
        </h1>
